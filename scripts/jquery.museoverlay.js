      ...
      var i = j.siblings("div"),
        ...
        s = {
          ...
          onWindowResize: function (a, b) {
            var c = l.width(),
              d = l.height();
            (b || k != c || n != d) && m == null && (m = setTimeout(function () {
          ...
          applyPageDimensions: function () {
            ...
            h.css("width", c.slideshow.$element.width()
              + "px")
          },
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
        ...
        if ("generator" == d.getAttribute("name")) {
          "2017.0.0.363" != d.getAttribute("content") && Muse.assets.outOfDate.push("jquery.museoverlay.js");
          break
        }
      }
    }
