    ...
    (function (b, c) {
      ...
      var g = {
        ...
        scopedFind: function (a, c, g, d) {
          for (var g =
              " " + g + " ", l = [], a = b(a).find(c), c = a.length, d = b(d)[0], k = 0; k < c; k++)
            for (var m = a[k], n = m; n;) {
    ...
    (function (b, c) {
      ...
      b.extend(c.ImageLoader.prototype, {
        ...
        _loadNext: function () {
          ...
          var a = this._queue;
          if (a.length) {
            if (this._needsSort) f =
              this._queue = a.sort(function (a, b) {
                var c = a.priority - b.priority;
                return c ? c : a.reqId - b.reqId
              }), a = f, this._needsSort = !1;
    ...
    (function (b, c) {
      ...
      b.extend(a.prototype, {
        ...
        _initialize: function () {
          ...
          var d = this;
          b("body").on("muse_bp_activate", function (a, b, c) {
        ...
        c.Widget, {
          ...
          _attachBehavior: function () {
            ...
            this.$element.on("keydown", function (b) {
              ...
              a.$element.removeClass(a.options.hoverClass
                + " " + a.options.activeClass);
    ...
    (function (b, c) {
      c.widget("Widget.TabGroup", c.Widget.RadioGroup, {
        ...
        checkButton: function (a) {
          ...
          this.options.contentLayout_runtime !== "lightbox" && b(c).attr({
            "aria-selected": "true"
          });
        ...
        c.Widget, {
          ...
          configureAria: function (a) {
            b.each(this.$element, function (c, d) {
              b(d).attr({
                role: "tabpanel",
                "aria-labelledby": a.buttons[c].$element.attr("id")
              });
              a.buttons[c].$element.attr({
                "aria-controls": b(d).attr("id")
              })
            })
          },
      ...
      c.Widget.Disclosure.AccordionTransitionPlugin = {
        ...
        _attachBehavior: function (a) {
          ...
          f.each(function (a) {
            ...
            c.overflow = a ? "" : "hidden";
            if (i
              === "vertical" || i === "both") c.height = a ? "auto" : "0";
        ...
        _transitionPanel: function (a, c, d) {
          ...
          if ((a = d.options.rotatedAccordion) && a.length > 0) {
            if (d.options.originalHeight == 0 && "undefined" !== typeof c) d.options.marginBottom =
              Muse.Utils.getCSSIntValue(a, "margin-bottom"), d.options.originalHeight = a[0].scrollHeight;
        ...
        _showPanel: function (a, c) {
          if (!a.$bp || a.$bp.hasClass("active")) {
            ...
            if (f === "horizontal" || f === "both") i.width = h[0].scrollWidth
              + "px";
            h.stop(!0, !0).queue("animationFrameFx", b.animationFrameFx).animate(i, {
      ...
      c.widget("Widget.ContentSlideShow", c.Widget.SlideShowBase, {
        ...
        _findWidgetElements: function (a) {
          var d = this.$element[0],
            a = c.scopedFind(d, a, this.options.slideshowClassName, d);
          a.sort(function (a, c) {
            var d = parseInt(b(a).attr("data-col-pos")
                || -1),
        ...
        _reprioritizeImageLoadingIfRequired: function (a) {
          !this._isLoaded(a)
            && this._cssilLoader && !this._cssilLoader.isQueueEmpty() && (a = b(this.slides.$element[a]), this._cssilLoader.reprioritize(this._getAjaxSrcForImage(a.is("img") ? a : a.find("img")), this.isPlaying()))
        },
        _bpActivate: function () {
        ...
        _attachBehavior: function () {
          ...
          if (!this.slides && (this.slides = new c.Widget.PanelGroup(d, {
              defaultIndex: this.slides && this.slides.activeIndex || b.defaultIndex || 0,
              toggleStateEnabled: h
            }), this.slides.bind("wp-panel-show", this._panelShowCallback), this.tabs = null, f.length)) this.tabs = new c.Widget.TabGroup(f, {
        ...
        _next: function () {
          ...
          !this.options.loop && 0 == c ? this.isPlaying() && this.stop() : this.options.playOnce && 0 == c && this.isPlaying() ? this.stop() : (!this.isPlaying() || this._isLoaded(b)
            && this._isLoaded(c)) && a.showPanel(c)
        },
        _goTo: function () {
          var a = this.slides;
    ...
    (function (b, c, a, d, j) {
      c.Widget.ContentSlideShow.fadingTransitionPlugin = {
        ...
        attachBehavior: function (f) {
          ...
          if (f.options.elastic === "fullWidth") {
            ...
            else p.on("orientationchange resize", function () {
              o()
            })
          }
            ...
            l.each(function () {
              ...
              a.swipe({
                ...
                swipeStatus: function (b, d, i, j) {
                  if (d == "start") f.stop();
                  else if (d == "move" && (g && (i == "left" || i == "right") || !g && (i == "up" || i == "down"))) !c.hasPointerCapture() && Math.abs(j) > 1 && c.setPointerCapture(a[0],
                    b), h._scrollTo(f, -1, j * (!k && (i == "left" || i == "up") || k && (i == "right" || i == "down") ? 1 : -1), 0);
        ...
        _scrollTo: function (a, c, d, g) {
          if (!a._ftpSwipeNoInterrupt) {
            ...
            if (!n && d == 0 || j == c) {
              ...
              k.each(function (d) {
                var i = b(this),
                  ...
                  m;
                d != c && (i.css("display") != "none" && i.css("opacity") != 0 ? (m = setTimeout(n, g + 10), i.stop(!1, !0).animate({
                  opacity: 0
                }, g, function () {
                  clearTimeout(m);
                  n()
            ...
            } else d = Math.abs(d), n = p.width(), d > n && (d = n), d = q.data("opacity") * (d / n), n = p.data("opacity") * (1 - d), p.stop(!1, !0).animate({
              opacity: n
            }, g), q.stop(!1, !0).show().animate({
              opacity: d
            }, g)
          }
        }
      ...
      c.Widget.ContentSlideShow.filmstripTransitionPlugin = {
        ...
        attachBehavior: function (f) {
          ...
          y !== "absolute" && y !== "fixed"
            && k.elastic !== "fullScreen" && o.css("position", "relative");
          ...
          var z = function (a, b) {
            ...
            k.elastic === "off" && (w[n ? "width" : "height"] = n && k.isResponsive ? "100%" : c + "px", w[n ? "height" : "width"] = n ? v
              + "px" : k.isResponsive ? "100%" : t + "px");
            return c
          };
          z();
          ...
          if (y) i.on("orientationchange resize", function () {
            z()
          });
          ...
          w.overflow = "visible";
          r.css(w);
          h._goToSlide(f, p.activeElement,
            k.transitionDuration);
          Muse.Browser.Features.Touch && f.options.enableSwipe === !0 && (b(this), n ? r.addClass("horizontalSlideShow") : r.addClass("verticalSlideShow"), r.swipe({
            triggerOnTouchEnd: !0,
            ...
            swipeStatus: function (a, b, d, g) {
              ...
              switch (b) {
                case "start":
                  ...
                  break;
                case "move":
                  if (n && d in x || !n && d in s) !c.hasPointerCapture() && Math.abs(g)
                    > 1 && c.setPointerCapture(r[0], a), h._scrollBy(f, g * i);
                  break;
                case "cancel":
                  h._goToSlide(f, p.activeElement, 0);
      ...
      c.Widget.ContentSlideShow.slideImageIncludePlugin = {
        ...
        _attachBehavior: function (a) {
          for (var b = this, c = a._cssilLoader, d = a._findWidgetElements("." + a.options.slideClassName),
              g = d.length, j = "." + a.options.imageIncludeClassName, n = a.options.slideLoadingClassName, p = function (c, d, g, k) {
            ...
            if (t) {
              ...
              if (v) r = {
                ...
                $ele: r,
                $slide: o
              }, t.style.visibility = "hidden", c.add(v, {
                callback: p,
                data: r
              }), o.addClass(n)
            }
        ...
        _handleImageLoad: function (a, b, c, d, g) {
          ...
          n.src =
            b;
          a.options.elastic !== "off" ? (j.data("imageWidth", c), j.data("imageHeight", d), a._csspPositionImage(n, a.options.heroFitting, a.options.elastic, c, d)) : (n.width = g.width || c, n.height = g.height || d);
          n.style.visibility = "";
      ...
      c.Widget.ContentSlideShow.shufflePlayPlugin = {
        ...
        _handleNext: function (a) {
          if (a.isPlaying()) {
            ...
            a._isLoaded(b) && a._isLoaded(c) && (a._goTo(c), ++a._shufflePlayCount >= a.slides.$element.length && (this._reshuffle(a), (!a.options.loop
        ...
        c.widget("Widget.Form", c.Widget, {
              ...
              _isEmpty: function (a) {
                ...
                switch (a.data("type")) {
                  case "checkboxgroup":
                  case "radiogroup":
                    return a = c.attr("name"), b('input[name="'
                      + a + '"]:checked').length == 0;
                  case "checkbox":
                  case "radio":
              ...
              _updateReCaptchaChallenge: function () {
                var a =
                  b("#recaptcha_response_field", this.$element);
                if (0 != a.length) {
              ...
              _attachBehavior: function () {
                var a = this;
                if (this._bpID = this.$element.closest(".breakpoint").attr("id")) b("body").on("muse_bp_activate", function (b,
                  c, d) {
                ...
                this.$element.find("input, textarea").bind("focus blur keydown change propertychange", function (c) {
                  ...
                  switch (c.type) {
                    case "focus":
                      ...
                      break;
                    case "keydown":
                      "checkbox" != k.data("type") && "radio"
                        != k.data("type") && k.addClass(d).removeClass(l);
                      break;
                    case "blur":
                      k.removeClass(h);
                    ...
                    case "change":
                    case "propertychange":
                      "radio" == k.data("type") && m.find("." + a.options.fieldWrapperClass).removeClass(i), a._isEmpty(k) ? k.addClass(l).removeClass(i) : k.addClass(i).removeClass(l), m && (a._isEmpty(m) ? m.addClass(l).removeClass(i) : m.addClass(i).removeClass(l))
                  }
                });
                switch (this.event) {
                  case "blur":
              ...
              _submitFormInternal: function () {
                  ...
                  b.ajax({
                        ...
                        beforeSend: function () {
                          ...
                          c.$element.find("."
                            + c.options.fieldWrapperClass).removeClass(c.options.focusClass);
                          l.attr("disabled", "disabled")
                        },
                        complete: function (k) {
                            k && (k.status >= 400 || k.responseText && k.responseText.indexOf("<?php")>=0)&&alert("Form PHP script is missing from web server, or PHP is not configured correctly on your web hosting provider. Check if the form PHP script has been uploaded correctly, then contact your hosting provider about PHP configuration.");c.$element.removeClass(j);var i=null;if(k&&k.responseText)try{i=d.parseJSON(k.responseText),
